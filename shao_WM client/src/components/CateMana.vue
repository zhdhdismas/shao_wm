  ...
  <el-container>
    ...
    <el-main class="cate_mana_main">
      ...
      >
        ...
        <el-table-column label="编号" prop="id" type="index"  width="120" align="center">
        </el-table-column>
        <el-table-column label="菜品分类名称" prop="name" width="120" align="center">
        </el-table-column>
...
export default {
  methods: {
    ...
    addNewCate() {
      ...
      if(this.cateName.length==0||"        ".indexOf(this.cateName)!=-1){
    ...
    handleEdit(index, row) {
      ...
      this.$prompt("请输入新名称", "编辑", {
        ...
        if (value == null || value.length == 0) {
          ...
          _this.loading = true;
          putRequest("/admin/category/update", { id: row.id, name: value }).then(
            (resp) => {
              var json = resp.data;
              _this.$message({
                type: json.status,
