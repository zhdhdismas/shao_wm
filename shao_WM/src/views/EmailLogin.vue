<template>
  ...
  >
    ...
    >
      <p>
        1.
        如果此邮箱未使用密码注册过,将为您自动注册一个账号,您可以通过主页的个人信息修改您的电话号码或用户名等个人信息
      </p>
      <p>
        2.
        如果此邮箱已经使用密码注册过,您邮箱登录的账号就为此账号,您仍能用密码登录
      </p>
      <p>
        3. 为了保证您的账号安全,验证码默认5分钟过期,请不要将验证码泄露给他人
      </p>
      <p>4. 由于服务器成本,您在1分钟以内肯定会收到验证码,请耐心等待</p>
    </el-dialog>
    <el-checkbox v-model="checked">已阅读注意事项</el-checkbox>&emsp;<span
